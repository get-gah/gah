...
@test "find_download_url should print match for the correct asset [linux/amd64]" {
	...
	DEBUG=""
	run find_download_url "$DIR/test/fixtures/releases/yazi/release.json"

	assert_success
	assert_output "https://github.com/sxyazi/yazi/releases/download/v25.5.31/yazi-x86_64-unknown-linux-gnu.zip
...
@test "find_download_url should print match for the correct asset [linux/arm64]" {
	...
	assert_success
	assert_output "https://github.com/sxyazi/yazi/releases/download/v25.5.31/yazi-aarch64-unknown-linux-gnu.zip
...
@test "find_download_url should print match for the correct asset [macos/amd64]" {
	...
	assert_success
	assert_output "https://github.com/sxyazi/yazi/releases/download/v25.5.31/yazi-x86_64-apple-darwin.zip"
}
...
@test "find_download_url should print match for the correct asset [macos/arm64]" {
	...
	assert_success
	assert_output "https://github.com/sxyazi/yazi/releases/download/v25.5.31/yazi-aarch64-apple-darwin.zip"
}
