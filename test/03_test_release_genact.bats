...
@test "find_download_url should print match for the correct asset [linux/amd64]" {
	...
	DEBUG=""
	run find_download_url "$DIR/test/fixtures/releases/genact/release.json"

	assert_success
	assert_output "https://github.com/svenstaro/genact/releases/download/v1.4.2/genact-1.4.2-x86_64-unknown-linux-gnu
...
@test "find_download_url should print match for the correct asset [linux/arm64]" {
	...
	assert_success
	assert_output "https://github.com/svenstaro/genact/releases/download/v1.4.2/genact-1.4.2-aarch64-unknown-linux-gnu
https://github.com/svenstaro/genact/releases/download/v1.4.2/genact-1.4.2-aarch64-unknown-linux-musl"
}
...
@test "find_download_url should print match for the correct asset [macos/amd64]" {
	...
	assert_success
	assert_output "https://github.com/svenstaro/genact/releases/download/v1.4.2/genact-1.4.2-x86_64-apple-darwin"
}
